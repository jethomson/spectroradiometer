...
% of the TSL230RD.
%
% Operating characteristics from the TSL230RD datasheet:
% With a sensitivity of 100x, frequency scaling of 1, Vdd = 5V, Ta = 25°C,
% Ee = 126 uW/cm^2, and λp = 640 nm the typical output frequency is 100 kHz.
...
%              and freq. scaling of 1 = 0.0079 [kHz/(uW/cm^2)] = 0.79 [kHz/(W/m^2)])
...
Ee = (126/k)*Xred; % model of AlInGaP test LED, [uW/cm^2/nm]
